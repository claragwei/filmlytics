...
class TMDBBatchCollector:
    ...
    def collect_all_periods(self):
        ...
        under_10k = [(2010, 1), (2011, 1), (2012, 1), (2013, 1), (2014, 1), (2015, 1), (2016, 1), (2017, 1), (2020, 1), (2025, 1)]
...
def main():
    ...
    df.to_csv('tmdb_final_2.csv', index=False, quoting=1)
    print(f"Saved to tmdb_final_2.csv")
